...
#define SFML_FRAME_RATE_LIMIT 60
#define DISPLAY_ROTATION 0  // Стартова орієнтація екрану

// #define SHOW_FPS             // Відображати значення FPS на дисплеї

// #define DOUBLE_BUFFERRING   // Подвійна буферизація не працює. Не реалізовано коректну передачу контексту.
