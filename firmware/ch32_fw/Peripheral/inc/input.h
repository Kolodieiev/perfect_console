...
/**
 * @brief Вмикає кнопку за порядковим номером, якщо її було зареєстровано.
 *
 * @param btn_pos - Порядковий номер кнопки, отриманий під час її реєстрації в системі обробки вводу.
 */
void enableBtnByPos (uint8_t btn_pos);

/**
 * @brief Вимикає кнопку за порядковим номером, якщо її було зареєстровано.
 *
 * @param btn_pos - Порядковий номер кнопки, отриманий під час її реєстрації в системі обробки вводу.
 */
