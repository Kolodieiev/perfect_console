...
Замість стандартного FileStream, що доступний в Arduino, за потреби використовуйте клас з файлу `pixeler/util/file/FileStream.h`.
...
З їх описом можна ознайомитись самостійно у файлі `pixeler/manager/FileManager.h` або через виклик підказки в IDE.
::: 
<br>
<br>
...
Усі налаштування карти пам'яті та її шини SPI знаходяться в файлі `pixeler_setup/sd_setup.h`.
