...
Усі віртуальні кнопки реєструються та налаштовуються для Pixeler в файлі `pixeler_setup/input_setup.h`.
...
Налаштувати піни I2C та адресу веденого пристрою в файлах `pixeler_setup/i2c_setup.h` та `pixeler_setup/coprocessor_setup.h`.
