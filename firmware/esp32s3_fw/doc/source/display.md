...
Налаштування бібліотеки та дисплею знаходяться в файлі `pixeler_setup/graphics_setup.h`.
<br>
<br>
...
::: {warning}
Pixeler наразі не підтримує використання однієї шини SPI для декількох зовнішніх пристроїв. Це викликано тим, що актуальний ESP-IDF драйвер шини SPI не може коректно взаємодіяти з різнотипними зовнішніми пристроями. Тому не намагайтеся підключити до однієї шини декілька зовнішніх пристроїв. Наприклад, дисплей + карту пам'яті. Якщо ситуація з драйвером SPI покращиться, в Pixeler буде додано підтримку різних пристроїв на одній шині.
::: 
