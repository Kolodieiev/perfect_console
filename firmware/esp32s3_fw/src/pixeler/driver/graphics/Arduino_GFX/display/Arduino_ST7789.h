...
static const uint8_t st7789_init_operations[] = {
    BEGIN_WRITE,
    WRITE_COMMAND_8,
    ST7789_SLPOUT,  // 2: Out of sleep mode, no args, w/delay
    END_WRITE,
    ...
    WRITE_C8_D8,
    ST7789_COLMOD,
    0x55,  // 3: Set color mode, 16-bit color
    WRITE_C8_D8,
    0x36,
    0x00,
    ...
    2,
    0x00,
    0xF0,  // 0xF0 MSB first, 0xF8 LSB first
    ...
    WRITE_COMMAND_8,
    ST7789_NORON,  // 4: Normal display on, no args, w/delay
    END_WRITE,
    ...
    BEGIN_WRITE,
    WRITE_COMMAND_8,
    ST7789_DISPON,  // 5: Main screen turn on, no args, w/delay
    END_WRITE};
...
public:
  Arduino_ST7789(
      ...
      uint8_t r = 0,
      bool ips = false,
      int16_t w = ST7789_TFTWIDTH,
      int16_t h = ST7789_TFTHEIGHT,
      uint8_t col_offset1 = 0,
      uint8_t row_offset1 = 0,
      uint8_t col_offset2 = 0,
