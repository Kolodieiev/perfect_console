...
#include "modules_setup/lora_setup.h"
...
namespace pixeler
{
  ...
  public:
     ...
     */
    TransmitPower getTransmitPower() const
    {
      return _transmit_power;
    }
    ...
    /**
     * @brief Записує усі налаштування модуля в його тимчасові регістри, та переводить модуль в режим сну.
     *
     ...
     * @return uint8_t
     */
    uint8_t getMaxChann() const
    {
      return MAX_CHANN_VAL;
    }
