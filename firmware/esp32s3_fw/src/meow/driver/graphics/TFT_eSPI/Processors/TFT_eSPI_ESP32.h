...
#define PARALLEL_INIT_TFT_DATA_BUS   \
  ...
  {                                  \
    xset_mask[c] = 0;                \
    if (c & 0x01)                    \
      xset_mask[c] |= (1 << TFT_D0); \
    if (c & 0x02)                    \
      xset_mask[c] |= (1 << TFT_D1); \
    if (c & 0x04)                    \
      xset_mask[c] |= (1 << TFT_D2); \
    if (c & 0x08)                    \
      xset_mask[c] |= (1 << TFT_D3); \
    if (c & 0x10)                    \
      xset_mask[c] |= (1 << TFT_D4); \
    if (c & 0x20)                    \
      xset_mask[c] |= (1 << TFT_D5); \
    if (c & 0x40)                    \
      xset_mask[c] |= (1 << TFT_D6); \
    if (c & 0x80)                    \
      xset_mask[c] |= (1 << TFT_D7); \
  }
