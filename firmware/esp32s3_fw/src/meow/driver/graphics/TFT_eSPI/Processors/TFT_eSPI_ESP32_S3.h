...
#if defined(CONFIG_IDF_TARGET_ESP32S3) or defined(CONFIG_IDF_TARGET_ESP32S2)
...
#define PARALLEL_INIT_TFT_DATA_BUS                   \
  ...
  {                                                  \
    xset_mask[c] = 0;                                \
    if (c & 0x01)                                    \
      xset_mask[c] |= (1 << (TFT_D0 - MASK_OFFSET)); \
    if (c & 0x02)                                    \
      xset_mask[c] |= (1 << (TFT_D1 - MASK_OFFSET)); \
    if (c & 0x04)                                    \
      xset_mask[c] |= (1 << (TFT_D2 - MASK_OFFSET)); \
    if (c & 0x08)                                    \
      xset_mask[c] |= (1 << (TFT_D3 - MASK_OFFSET)); \
    if (c & 0x10)                                    \
      xset_mask[c] |= (1 << (TFT_D4 - MASK_OFFSET)); \
    if (c & 0x20)                                    \
      xset_mask[c] |= (1 << (TFT_D5 - MASK_OFFSET)); \
    if (c & 0x40)                                    \
      xset_mask[c] |= (1 << (TFT_D6 - MASK_OFFSET)); \
    if (c & 0x80)                                    \
      xset_mask[c] |= (1 << (TFT_D7 - MASK_OFFSET)); \
  }
...
#define tft_Write_16(C)                         \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;             \
  GPIO_SET_REG = set_mask((uint8_t)((C) >> 8)); \
  WR_H;                                         \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;             \
  GPIO_SET_REG = set_mask((uint8_t)((C) >> 0)); \
  WR_H
...
#define tft_Write_32(C)                          \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;              \
  GPIO_SET_REG = set_mask((uint8_t)((C) >> 24)); \
  WR_H;                                          \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;              \
  GPIO_SET_REG = set_mask((uint8_t)((C) >> 16)); \
  WR_H;                                          \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;              \
  GPIO_SET_REG = set_mask((uint8_t)((C) >> 8));  \
  WR_H;                                          \
...
#define tft_Write_32C(C, D)                     \
  ...
  WR_H;                                         \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;             \
  GPIO_SET_REG = set_mask((uint8_t)((D) >> 8)); \
  WR_H;                                         \
  GPIO_CLR_REG = GPIO_OUT_CLR_MASK;             \
  GPIO_SET_REG = set_mask((uint8_t)((D) >> 0)); \
  WR_H
