...
void PrefSelectContext::showMainTmpl()
{
  ...
  Label* bright_lbl = creator.getItemLabel(STR_BRIGHT, u8g2_font_unifont_t_cyrillic, 2);
  ...
  Label* mono_lbl = creator.getItemLabel(STR_AUDIO_MONO, u8g2_font_unifont_t_cyrillic, 2);
  ...
  Label* file_server_lbl = creator.getItemLabel(STR_FILE_SERVER, u8g2_font_unifont_t_cyrillic, 2);
