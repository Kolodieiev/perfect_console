#pragma once
// Реалізовано на основі бібліотеки TAMC_GT911
...
#define ROTATION_0 (uint8_t)0
#define ROTATION_90 (uint8_t)1
#define ROTATION_180 (uint8_t)2
#define ROTATION_270 (uint8_t)3
